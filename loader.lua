...
AddSlider("Speed", 10, 40, 20, function(v) Config.MovementSpeed = v end)
    ...
    while IsScriptActive do
        if Config.AutofarmEnabled then
            ...
            if coinPart then
                ...
                if dist > 3 then
                    TweenTo(coinPart.Position, Config.MovementSpeed)
                end
                if (coinPart.Position - hrp.Position).Magnitude < 5 then
                    ...
                    if coinPart.Parent then
                        ...
                        task.delay(5, function()
                            if coinPart.Parent then CoinBlacklist[coinPart.Parent] = nil end
                        end)
                    end
                end
            else
